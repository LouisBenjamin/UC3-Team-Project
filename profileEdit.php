...
<html lang="en-US">
<head>
    <title> Editing My profile</title>
    <meta charset="utf-8"/>
    <title>Tato</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
    <!--    <link rel="stylesheet" href="css/main.css">-->
    <style type="text/css">
    body {background-image: url("assets/images/like-tato.png");}
    #fieldset_A {border-color: #FF7F50; background-color: #FFA07A}
    #fieldset_B {border-color: #FF1493; background-color: #FFB6C1}
    #legendA    {color: #FF7F50}
    #legendB    {color: #FF1493}
    .label      {color: #FF7F50; font-weight: bold; font-size: 12pt}
    .textInput  {width: 400px}
    h4 {font-weight: bolder; font-size: 20pt; text-align: center}
    #information {background-color: #FFEBCD}
        ...
        <div class="container">
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading"><h4>User Profile - Edit mode</h4></div>
                    <div class="panel-body">
                       ...
                       <div id="information">
                        ...
                        <!--
                        <form>
                            <span style="width:50px;"></span>Old Password</p>
                            <span style="width:50px;"></span>New Password</p>
